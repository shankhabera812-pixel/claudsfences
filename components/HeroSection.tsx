      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-6 pt-32 pb-16 flex flex-col justify-center min-h-[100vh] lg:min-h-[700px]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-10 items-center">
          ...
          <div className="flex-1 text-center lg:text-left w-full">
            {/* Typographic Kicker */}
            <div className="hero-animate flex items-center gap-2.5 mb-3.5 w-full">
            ...
            <h1 className="hero-animate delay-150 text-[clamp(2.75rem,5.5vw,4.5rem)] font-serif font-bold text-offwhite leading-[1.05] mb-6 drop-shadow-md tracking-tight">
            ...
            <p className="hero-animate delay-300 text-[17px] sm:text-[19px] text-offwhite/95 font-medium leading-relaxed mb-10 max-w-[560px] mx-auto lg:mx-0 drop-shadow-sm">
            ...
            <div className="hero-animate delay-450 flex flex-col items-center lg:items-start gap-6 mt-4">
          ...
          <div className="hero-animate delay-600 w-full lg:w-[440px] flex-shrink-0 relative">
